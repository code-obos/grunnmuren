  ...
  return (
    <Heading>
      <button
        className={cx(
          className,
          'focus-visible:outline-blue-dark flex w-full items-center justify-between px-5 py-4 text-left text-lg font-semibold focus:outline-none focus-visible:outline-4 focus-visible:outline-offset-0',
