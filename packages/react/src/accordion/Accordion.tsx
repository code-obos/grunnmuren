            ...
            HeadingContext,
            {
              ...
              _innerWrapper: (children) => (
                <button
                  ...
                  className="flex min-h-[44px] w-full items-center justify-between gap-1.5 rounded-lg px-2 py-3.5 text-left focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[-4px] focus-visible:outline-black"
                  id={buttonId}
