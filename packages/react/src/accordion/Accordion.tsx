            ...
            HeadingContext,
            {
              ...
              _innerWrapper: (children) => (
                <button
                  ...
                  className="focus-visible:outline-focus-inset focus-visible:outline-focus flex min-h-[44px] w-full items-center justify-between gap-1.5 rounded-lg px-2 py-3.5 text-left"
                  id={buttonId}
