  ...
  return {
    plugins: [
      ...
      plugin(function ({ addBase, addComponents }) {
        ...
        const blockquote =
          '@apply italic font-normal grid pl-8 text-[1rem]/[1.625rem] md:text-[1rem]/[1.6875rem] before:text-[4.6875rem]/[1] before:-ml-8 before:-mb-12 before:font-bold before:content-["\\""]';
