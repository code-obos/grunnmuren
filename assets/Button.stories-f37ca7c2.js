'use client';
import{a,F as l,j as t}from"./jsx-runtime-289d1c53.js";import{r as i}from"./index-9a95590f.js";import{h as p}from"./icons-17850174.js";import{B as b}from"./ButtonColorContext-2301757a.js";import"./clsx.m-388a5213.js";const r={Text:"Text",Icon:"Icon",TextIcon:"Text Icon",IconText:"Icon Text"},v={title:"Button",argTypes:{composition:{options:Object.values(r),control:"select",defaultValue:r.Text},disabled:{control:"boolean",defaultValue:!1},loading:{control:"boolean",defaultValue:!1}}},c=n=>{const{composition:s,disabled:e,loading:o}=n,m=({children:d})=>{switch(s){case r.Icon:return t(p,{});case r.TextIcon:return a(l,{children:[d,t(p,{})]});case r.IconText:return a(l,{children:[t(p,{}),d]});default:return d}},u=[t(b,{children:t(m,{children:"Button"})},"button"),t(b,{href:"#",children:t(m,{children:"Link"})},"link")];return a(l,{children:[t(h,{buttonProps:{disabled:e,loading:o},children:u}),t("div",{className:"bg-green-dark py-4",children:t(h,{buttonProps:{color:"light-green",disabled:e,loading:o},children:u})}),t("div",{className:"bg-blue py-4",children:t(h,{buttonProps:{color:"white",disabled:e,loading:o},children:u})})]})},h=n=>{const{children:s,buttonProps:e={}}=n;return a(l,{children:[t(g,{children:i.Children.map(s,o=>i.cloneElement(o,e))}),t(g,{children:i.Children.map(s,o=>i.cloneElement(o,{variant:"secondary",...e}))})]})},g=n=>t("div",{className:"my-8 flex flex-row justify-center gap-8",...n});var B,f,x;c.parameters={...c.parameters,docs:{...(B=c.parameters)==null?void 0:B.docs,source:{originalSource:`(props: {
...
//# sourceMappingURL=Button.stories-f37ca7c2.js.map
